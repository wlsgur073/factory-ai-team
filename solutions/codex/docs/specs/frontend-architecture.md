...
export async function generateMetadata({
  ...
  return { title: `검증 상세 #${params.executionId} — Codex — Nexus` };
}
```
...
const menuConfig = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/users", label: "사용자 관리", icon: Users, show: true },
      { href: "/admin/permissions", label: "권한 관리", icon: Key, show: true },
      {
